...
# print("API KEY:", settings.AIML_API_KEY)  # Debugging
...
@router.post("/geneticFiles")
async def upload_genetic_file(
    promptText: str = Form(...),
    ...
    try:
        result = await db["genetic"].insert_one(report)
